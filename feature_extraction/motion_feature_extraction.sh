...
mpirun -n 1 $py ./scripts/feature_extraction/extract_transform2.py $1 --feature_name bvh_expmap --transforms scaler
mpirun -n $n $py ./scripts/feature_extraction/apply_transforms.py $1 --feature_name bvh_expmap --transform_name scaler --new_feature_name expmap_scaled
